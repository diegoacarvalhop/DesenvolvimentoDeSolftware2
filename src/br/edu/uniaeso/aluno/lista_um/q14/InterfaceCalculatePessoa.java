...
public class InterfaceCalculatePessoa {
    ...
    public InterfaceCalculatePessoa() {
        setPessoas(null);
        setUser_altura(0);
        setUser_sexo("");
        setPessoa(null);
    ...
    public InterfaceCalculatePessoa(List<Pessoa> pessoas, double user_altura, String user_sexo, Pessoa pessoa) {
    ...
    public void calculate() {
        ...
        System.out.println(c.getNumberWoman(getPessoas()));
        System.out.println(c.getMaiorMenorAltura(getPessoas()));
        System.out.println(c.getMediaAlturaHomens(getPessoas()));
    }
