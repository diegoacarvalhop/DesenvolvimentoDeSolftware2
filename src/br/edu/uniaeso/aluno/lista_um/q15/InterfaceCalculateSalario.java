...
public class InterfaceCalculateSalario {
    ...
    public InterfaceCalculateSalario() {
    ...
    public InterfaceCalculateSalario(List<Funcionario> funcionarios, double user_salario, String user_nome, Funcionario pessoa) {
