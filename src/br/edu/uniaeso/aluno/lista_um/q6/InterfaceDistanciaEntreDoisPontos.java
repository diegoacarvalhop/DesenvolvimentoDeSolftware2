...
public class InterfaceDistanciaEntreDoisPontos {
    private double user_ponto_x1, user_ponto_x2, user_ponto_y1, user_ponto_y2;
    private Scanner get;

    public InterfaceDistanciaEntreDoisPontos() {
        setUser_ponto_x1(0);
        setUser_ponto_x2(0);
        setUser_ponto_y1(0);
        setUser_ponto_y2(0);
    ...
    public InterfaceDistanciaEntreDoisPontos(double user_ponto_x1, double user_ponto_x2, double user_ponto_y1, double user_ponto_y2) {
    ...
    public double calculateDistancia() {
        DistanciaEntreDoisPontos d = new DistanciaEntreDoisPontos(getUser_ponto_x2(), getUser_ponto_x2(), getUser_ponto_y1(), getUser_ponto_y2());
