...
public class InterfaceIntervaloDeNumerosInteiros {
    private int user_limite_inferior, user_limite_superior;
    private Scanner get;

    public InterfaceIntervaloDeNumerosInteiros() {
        setUser_limite_inferior(0);
        setUser_limite_superior(0);
        setGet(new Scanner(System.in));
    }

    public InterfaceIntervaloDeNumerosInteiros(int user_limite_inferior, int user_limite_superior) {
    ...
    public void calculateIntervalo() {
        if (getUser_limite_inferior() > getUser_limite_superior()) {
            ...
            IntervaloDeNumerosInterios i = new IntervaloDeNumerosInterios(getUser_limite_inferior(), getUser_limite_superior());
