...
public class InterfaceIdentificarTriangulo {
    private int user_lado_a, user_lado_b, user_lado_c;
    private Scanner get;

    public InterfaceIdentificarTriangulo() {
        setUser_lado_a(0);
        setUser_lado_b(0);
        setUser_lado_c(0);
    ...
    public InterfaceIdentificarTriangulo(int user_lado_a, int user_lado_b, int user_lado_c) {
